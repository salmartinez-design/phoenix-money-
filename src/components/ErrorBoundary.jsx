...
export class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) { console.error('Xentli Error:', error, info); }
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', height:'100vh', gap:16, padding:32, background:'var(--bg)', fontFamily:"'Outfit',system-ui,sans-serif" }}>
          ...
          <p style={{ color:'var(--text-secondary)', fontSize:14, textAlign:'center', maxWidth:400 }}>Xentli hit an unexpected error. Your data is safe in local storage.</p>
